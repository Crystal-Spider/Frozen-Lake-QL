...
int cellNum = 8; //Cells number per row/column (To make the game work, this value must be >= 2).
int states = cellNum*cellNum; //Total cells number.
int cellDim = size/cellNum; //Single cell dimension.
int frame = 1000; //FPS.
